...
export const LOCAL_GROUP: LocalGalaxy[] = [
  { name: "Milky Way",          x: 0,    y: 0,    z: 0,    size: 11, color: 0xbcd0ff, kind: "spiral", tex: "m101.png", label: true },
  { name: "Andromeda (M31)",    x: 2.2,  y: 0.3,  z: 1.1,  size: 15, color: 0xdfe6ff, kind: "spiral", tex: "m31.png",  label: true },
  { name: "Triangulum (M33)",   x: 2.0,  y: -0.5, z: 1.6,  size: 8,  color: 0xc7d4ff, kind: "spiral", tex: "m33.png" },
